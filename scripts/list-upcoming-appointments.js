...
const hoursBefore = Number(
  args.hoursBefore || process.env.APPOINTMENT_REMINDER_HOURS_BEFORE || 3,
);
const windowMinutes = Number(
  args.windowMinutes || process.env.APPOINTMENT_REMINDER_WINDOW_MINUTES || 30,
);
const limit = Number(
  args.limit || process.env.APPOINTMENT_REMINDER_BATCH_SIZE || 50,
);
