      ...
      <div className="container mx-auto max-w-4xl px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <p>
              Ao acessar e usar o TôLivre, você concorda em cumprir estes Termos de Uso. Se você não
          ...
          <section>
            ...
            <p>
              O TôLivre é uma plataforma de gestão de agendamentos online para profissionais de beleza
              e bem-estar. Oferecemos ferramentas para agendamento, gestão de clientes, controle
              financeiro e integração com WhatsApp.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Oferecemos diferentes planos de assinatura com recursos variados. Os preços estão
              disponíveis em nossa página de preços e podem ser alterados mediante aviso prévio.
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p>
              Todo o conteúdo, recursos e funcionalidades do TôLivre são propriedade exclusiva da
              empresa e estão protegidos por leis de propriedade intelectual.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              O TôLivre é fornecido "como está" e não garantimos que o serviço será ininterrupto ou
              livre de erros. Não nos responsabilizamos por danos indiretos, incidentais ou
          ...
          <section>
            ...
            <p>
              Reservamos o direito de modificar estes termos a qualquer momento. Notificaremos os
              usuários sobre mudanças significativas por email ou através do painel.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">9. Cancelamento e Encerramento</h2>
            <p>
              Você pode cancelar sua conta a qualquer momento através do painel. Podemos encerrar ou
              suspender sua conta se você violar estes termos.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:contato@tolivre.com" className="text-primary hover:underline">
                contato@tolivre.com
              </a>
            </p>
          </section>
