  ...
  if (time.ended) {
    return (
      <div ref={containerRef} className="mx-auto mb-6 max-w-2xl">
        <div
          ref={bannerRef}
          className="launch-banner bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full px-4 py-2 text-black font-semibold text-center flex items-center justify-center gap-6 shadow-lg"
        >
